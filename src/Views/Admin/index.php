            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="./auth/register.php" class="text-violet-600 hover:text-violet-700 font-medium">S'inscrire</a>
                        <a href="../auth/login.php" class="bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white px-6 py-3 rounded-xl hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-violet-200">
                            Connexion
                        </a>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 relative">
            <div class="flex flex-wrap items-center">
                <div class="w-full lg:w-1/2 mb-12 lg:mb-0">
                    <div class="relative">
                        <div class="inline-flex items-center space-x-2 px-4 py-2 bg-violet-500/20 text-violet-300 rounded-2xl text-sm mb-6 animate-bounce">
                    ...
                    <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl relative overflow-hidden group">
                        ...
                        <div class="relative">
                            ...
                            <form class="space-y-6">
                                ...
                                <!-- Search Button -->
                                <button class="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-4 rounded-xl hover:opacity-90 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-violet-500/25">
    ...
    <div class="py-12 bg-white/50 backdrop-blur-lg border-y border-slate-200">
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center items-center flex-wrap gap-12">
                <img src="/api/placeholder/120/40" alt="Company 1" class="h-8 grayscale hover:grayscale-0 transition-all duration-200">
                <img src="/api/placeholder/120/40" alt="Company 2" class="h-8 grayscale hover:grayscale-0 transition-all duration-200">
                <img src="/api/placeholder/120/40" alt="Company 3" class="h-8 grayscale hover:grayscale-0 transition-all duration-200">
                <img src="/api/placeholder/120/40" alt="Company 4" class="h-8 grayscale hover:grayscale-0 transition-all duration-200">
                <img src="/api/placeholder/120/40" alt="Company 5" class="h-8 grayscale hover:grayscale-0 transition-all duration-200">
            </div>
        </div>
    </div>
    ...
    <section class="py-20">
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center mb-16">
                <div class="inline-flex items-center px-4 py-2 bg-violet-100 text-violet-600 rounded-full text-sm mb-4">
    ...
    <section class="py-20 bg-slate-50/50">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-12">
                <a href="#" class="inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white px-8 py-4 rounded-xl hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-violet-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <span class="text-2xl font-bold text-white">CareerLink</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Offres d'emploi</a></li>
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Entreprises</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Développement</a></li>
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Design</a></li>
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Marketing</a></li>
                        <li><a href="#" class="hover:text-white transition-colors duration-200">Finance</a></li>
                    </ul>
                </div>
